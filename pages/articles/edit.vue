                    ...
                    <div>
                        ...
                        <div class="mt-6 grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-6">
                            <div class="col-span-12">
                                ...
                                <div class="mt-1">
                                    <input id="title" v-model="articleData.title" placeholder="請撰輸入文章標題" name="title"
                            ...
                            <div class="col-span-12">
                                ...
                                <div class="mt-1">
                                    <input id="cover" v-model="articleData.cover" placeholder="請撰輸入網址連結" name="cover"
                                        type="text" autocomplete="cover"
                                        class="block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-emerald-500 focus:outline-none focus:ring-emerald-500 sm:text-sm" />
                                </div>
                            </div>
                            ...
                            <div class="col-span-12">
                                ...
                                <div class="mt-1">
                                    <textarea id="content" v-model="articleData.content" name="content" rows="4"
                                        placeholder="請撰寫文章內容..."
                                        class="block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-emerald-500 focus:outline-none focus:ring-emerald-500 sm:text-sm" />
                                </div>
                            </div>
...
<script setup>
    ...
    const handleSubmit = async () => {
        // 帶著路徑參數 query.id 發送API 並等待取回文章資訊
    ...
    // 設定每次請求本頁路徑時, 必須先經過前端路由中間件 auth 的權限檢查
    definePageMeta({
        middleware: 'auth'
    })
</script>